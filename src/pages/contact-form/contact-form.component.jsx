      ...
      <Jumbotron className="contact-jumbotron">
        <Row>
          <Col className="d-flex justify-content-center flex-wrap">
            <div className="m-2">
              <a href="mailto:revatid15@gmail.com" target="_blank" rel="noopener noreferrer">
                <Button variant="outline-danger" title="revatid15@gmail.com">
            ...
            <div className="m-2">
              <a href="https://www.facebook.com/revati.dongare" target="_blank" rel="noopener noreferrer">
